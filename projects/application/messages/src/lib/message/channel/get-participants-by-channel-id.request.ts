...
export class GetParticipantsByChannelIdRequest {
  ...
  constructor({ channelId = '', filters = '', sort = '', pageSize = 16, page = 1 }: { channelId?: string; filters?: string; sort?: string; pageSize?: number; page?: number }) {
